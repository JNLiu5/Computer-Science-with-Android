...
public class GhostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            System.out.println("Error: dictionary not found: " + e);
        }
        onStart(null);
    }
    ...
    private void computerTurn() {
        ...
        String longer_word = dictionary.getGoodWordStartingWith(ghostWord);
        if(longer_word == null || longer_word.isEmpty()) {
            label.setText("Computer wins!");
            button.setEnabled(false);
            return;
        }
        ghostWord = longer_word.substring(0, ghostWord.length() + 1);
        TextView word = (TextView) findViewById(R.id.ghostText);
        word.setText(ghostWord);
        userTurn = true;
        label.setText(USER_TURN);
    }
    ...
    public void challenge(View view) {
        ...
        if(ghostWord.length() >= 4 && dictionary.isWord(ghostWord)) {
            ...
            String candidate = dictionary.getAnyWordStartingWith(ghostWord);
            if(candidate != null) {
